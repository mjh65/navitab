...
// This file provides the main function for the MSFS app variant of Navitab.
...
int main(int arg, char** argv)
{
    ...
    try {
        ...
        nvt = navitab::CoreServices::MakeNavitab(navitab::SimEngine::MSFS, navitab::WinServer::DESKTOP);
    }
