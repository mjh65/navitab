...
XCOPY /I /S "%1\svg\*.*" "%CD%\fspt\PackageSources\html_ui\icons\toolbar"
MD "%CD%\fspt\PackageSources\html_ui\Textures\Menu\toolbar"
XCOPY /I /S "%1\svg\*.*" "%CD%\fspt\PackageSources\html_ui\Textures\Menu\toolbar"
MD "%CD%\fspt\PackageSources\html_ui\InGamePanels\NavitabPanel"
XCOPY /I /S "%1\html\*.*" "%CD%\fspt\PackageSources\html_ui\InGamePanels\NavitabPanel"
XCOPY /I /S "%1\..\..\res\svg\*.svg" "%CD%\fspt\PackageSources\html_ui\InGamePanels\NavitabPanel"
...
XCOPY /I /S "%CD%\fspt\Packages\%_pkgname_%\Build\html_ui" "%CD%\%_pkgname_%\html_ui"
